...
class ResNetMulti(nn.Module):
    def __init__(self, block, layers, num_classes, multi_level=False):
        ...
        self.maxpool = nn.MaxPool2d(
            kernel_size=3, stride=2, padding=1, ceil_mode=False)  # change
...
def DeeplabMulti(num_classes=15, init=None, multi_level=False):
    # Create model
    model = ResNetMulti(Bottleneck, [3, 4, 23, 3], num_classes, multi_level=multi_level)
